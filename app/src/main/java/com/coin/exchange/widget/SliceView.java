...
public class SliceView extends View {
    ...
    private void init(Context context) {
        ...
        mLeftText = context.getString(R.string.position_security_add);
        mRightText = context.getString(R.string.position_security_reduce);
...
//                Log.i(TAG, "onTouchEvent: ACTION_MOVE");
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mListener != null) {
                    mListener.onClickSlicePos(upIndex);
                }
...
//                Log.i(TAG, "onTouchEvent: ACTION_UP");
    ...
    public interface ClickListener {
        void onClickSlicePos(int index);
    }
