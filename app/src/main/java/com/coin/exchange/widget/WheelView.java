...
//                    Log.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(String item) {
        ...
        if (0 == itemHeight) {
            ...
            mViews.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, itemHeight * displayItemCount));
...
//            position = divided + offset + 1;
    ...
    private void onSeletedCallBack() {
        if (null != mOnWheelViewListener) {
            mOnWheelViewListener.onSelected(selectedIndex, mItems.get(selectedIndex));
        }
    ...
    public String getSeletedItem() {
        return mItems.get(selectedIndex);
    }
