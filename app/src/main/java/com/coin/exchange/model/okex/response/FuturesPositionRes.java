 ...
 * @description 合约持仓信息
 */
public class FuturesPositionRes {
    ...
    // 账户类型：逐仓 fixed 全仓 crossed
//    @SerializedName("margin_mode")
//    private String margin_mode;

    //持仓信息
    @SerializedName("holding")
    private List<List<Holding>> holding;
...
//    }
    ...
    public List<List<Holding>> getHolding() {
        return holding;
    }

    public void setHolding(List<Holding> holding) {
        ArrayList<List<Holding>> list = new ArrayList<>();
        list.add(holding);
        this.holding = list;
    }
