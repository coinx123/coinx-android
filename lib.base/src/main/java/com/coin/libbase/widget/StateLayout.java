...
public class StateLayout extends FrameLayout {
    ...
    public View setLoadingView(View view) {
        ...
        if (loadingView != null && JFrameManager.getInstance().isDebug()) {
    ...
    public View setEmptyView(View view) {
        ...
        if (emptyView != null && JFrameManager.getInstance().isDebug()) {
    ...
    public View setRetryView(View view) {
        ...
        if (retryView != null && JFrameManager.getInstance().isDebug()) {
    ...
    public View setContentView(View view) {
        ...
        if (contentView != null && JFrameManager.getInstance().isDebug()) {
